...
**Note**: Be sure to review the [Homework Guide](../../supplemental/homework_guide.md) and the [Good README Guide](../../supplemental/good_readme_guide.md) before you start working on this assignment!
...
* Satisfies all of the above acceptance criteria plus the following code improvements:
  ...
  * Application's CSS selectors and properties are consolidated and o rganized to follow semantic structure.
